...
public class JdbcUserDaoTests extends BaseDaoTests {
    protected static final User USER_1 = new User(1, "user1", "user1", "ROLE_USER", "New User", "new@example.com", 12345, "123 Main St");
    protected static final User USER_2 = new User(2, "user2", "user2", "ROLE_USER", "New User", "new@example.com", 12345, "123 Main St");
    private static final User USER_3 = new User(3, "user3", "user3", "ROLE_USER", "New User", "new@example.com", 12345, "123 Main St");
    ...
    public void create_user_with_null_username() {
        sut.createUser(null, USER_3.getPassword(), "ROLE_USER", USER_3.getFullName(), USER_3.getEmail(), USER_3.getZipCode(), USER_3.getAddress());
    }

    @Test(expected = DataIntegrityViolationException.class)
    public void create_user_with_existing_username() {
        sut.createUser(USER_1.getUsername(), USER_3.getPassword(), "ROLE_USER", USER_3.getFullName(), USER_3.getEmail(), USER_3.getZipCode(), USER_3.getAddress());
    }

    @Test(expected = IllegalArgumentException.class)
    public void create_user_with_null_password() {
        sut.createUser(USER_3.getUsername(), null, "ROLE_USER", USER_3.getFullName(), USER_3.getEmail(), USER_3.getZipCode(), USER_3.getAddress());
    }

    @Test
    public void create_user_creates_a_user() {
        User newUser = new User(-1, "new", "user", "ROLE_USER", "New User", "new@example.com", 12345, "123 Main St");

        boolean userWasCreated = sut.createUser(newUser.getUsername(), newUser.getPassword(), "ROLE_USER",newUser.getFullName(), newUser.getEmail(), newUser.getZipCode(), newUser.getAddress());
